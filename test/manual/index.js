...
document.querySelector('.Test-run--basicElement .Action--destroyInstance').addEventListener('click', () => {
	basicElementInstance.destroy();
}, false);
document.querySelector('.Test-run--basicElement .Action--createInstance').addEventListener('click', () => {
